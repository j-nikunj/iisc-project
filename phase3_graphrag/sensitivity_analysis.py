...
def main() -> None:
    ...
    output_base = base_dir / "output" / "sensitivity"
    ...
    experiments = [
        ...
        {
            "name": "k8_h1_operational",
            "top_k": 8,
            "hops": 1,
            "edges": ["IMPACTS", "DEPENDS_ON", "CONSTRAINS"],
            "node_classes": [],
            "edge_label": "operational",
        },
        {
            "name": "k8_h1_maintenance_overlap",
            "top_k": 8,
            "hops": 1,
            "edges": ["MAINTAINS", "OVERLAPS_WITH"],
            "node_classes": [],
            "edge_label": "maintenance_overlap",
        },
        {
            "name": "k8_h1_transit_corridor",
            "top_k": 8,
            "hops": 1,
            "edges": [],
            "node_classes": ["transit_service", "corridor"],
            "edge_label": "all",
        },
    ]
    ...
    summary = {
        ...
        "notes": {
            "breadth_limits": "Context max_nodes is fixed by config and not varied here.",
            "node_class_filtering": "One config applies node-class filtering for sensitivity; others use default.",
        },
    }
    ...
    md_lines.append("")
    md_lines.append("Architectural interpretation:")
    md_lines.append(
